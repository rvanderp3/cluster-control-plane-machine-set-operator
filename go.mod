...
replace (
	github.com/openshift/api => github.com/rvanderp3/api v0.0.0-20230828172152-24b3e2b2872b
	github.com/openshift/client-go => github.com/rvanderp3/client-go v0.0.0-20230828172926-6651ab1c656a
